...
/**
 * This activity that capture a picture from an Android Things
...
public class CameraActivity extends Activity {
    ...
    /**
     * Upload image data to Firebase as an event.
     */
    private void onPictureTaken(final byte[] imageBytes) {
        if (imageBytes != null) {
            final DatabaseReference log = mDatabase.getReference("logs");
            final StorageReference imageRef = mStorage.getReference().child("OCR_IMAGE");
            ...
            task.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    log.child("OCRIMAGE").child("timestamp").setValue(ServerValue.TIMESTAMP);
                    log.child("OCRIMAGE").child("image").setValue(downloadUrl.toString());
        ...
        mCloudHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (annotations != null) {
                        ref.child("OCRIMAGE").child("annotations").setValue(annotations);
                    }
                } catch (IOException e) {
